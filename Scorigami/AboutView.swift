    ...
    var body: some View {
        HStack {
            ...
            VStack {
                ...
                Text("Scorigami, a term originally coined and defined by sportswriter Jon Bois, refers to the final score of an NFL game that has never occurred.\n").frame(maxWidth: .infinity, alignment: .leading)
                Text("This app let's you browse every score combination and see which are Scorigamis (hint: tap the black cells). For those final scores that have occurred, you can see how many games ended in that score and when it last happened.\n").frame(maxWidth: .infinity, alignment: .leading)
